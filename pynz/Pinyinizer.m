...
- (NSString*)convertToPinyin:(NSString*)input {
    ...
    NSString *hanzi = [self convertPunctuation:input];
...
//    }
//    
   // url = [NSURL fileURLWithPath: [NSTemporaryDirectory() stringByAppendingPathComponent: @"Pinyinize.sqlite"]];
   
    url = [NSURL fileURLWithPath:  [[NSBundle mainBundle] pathForResource:@"Pinyinize" ofType:@"sqlite"]];
